...
public class ProductPage extends JFrame implements MouseListener, ActionListener{
	...
	//        }
        ...
        centerContainer.setLayout(centerBox);
	        ...
	        JLabel feedbackString = new JLabel("Comments :");
        ...
        centerContainer.add(feedbackString);
	       ...
	       //retrieve feedback data form database
	        ...
	        {
	        	JPanel feedbackPanel = new JPanel(new GridLayout(0,1,0,0));
	        	JLabel feedbackLabel = new JLabel(feedback);
	        	feedbackLabel.setFont(new Font("Lucida Grande", Font.PLAIN, 19));
	        	JPanel ratingPanel = new JPanel(new FlowLayout(FlowLayout.LEADING,0,0));
	            ...
	            for(int i = 1 ; i <= ratings ; i++)
	            {
	            	...
	            	ImageIcon starIcon = createResizedIcon("/resources/uiSymbol/ratingStar.png",18,12);
        ...
        //add cart button
        JPanel northRightPanel = new JPanel(new FlowLayout(FlowLayout.TRAILING));
